...
- <span style="color:#FF6B6B;">Ещё открыто:</span>
  - финальная фиксация product-grade Wi-Fi onboarding как действительно завершённого пользовательского сценария
...
- 2026-04-20 — Пересобран внешний ChatGPT workflow под экономию ресурса: `mc_core.v4.ini`, task capsule и project settings вынесены в канонический внешний пакет `docs/chatgpt_git/`. Это должно снизить расход ресурса на мелких локальных правках без потери контроля со стороны Codex.
