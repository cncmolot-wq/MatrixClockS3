...
- code audit radar: https://github.com/cncmolot-wq/MatrixClockS3/blob/main/chatgpt_git/CHATGPT_CODE_AUDIT_RADAR_RU.md
...
- project PROJECT_TREE_RU: https://github.com/cncmolot-wq/MatrixClockS3/blob/main/project/PROJECT_TREE_RU.md
...
КОНТЕКСТ ПРОЕКТА:
- PROJECT_TREE_RU = дерево проэкта для наглядности структуры файлов
- CHATGPT_CODE_AUDIT_RADAR_RU = короткий шаблон для сканирования файлов по P1/P2/P3 без интеграционных решений
