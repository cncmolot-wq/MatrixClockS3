...
- Technical source of truth: `project/REFACTOR_PLAN_RU.md`
- Project rules and editing contract: `project/PROJECT_EDIT_RULES.md`
- Descriptive overview: `chatgpt_git/CHATGPT_CODE_AUDIT_RADAR_RU.md`
- Board/profile reference: `project/N16R8_PROFILE_BIBLE_RU.md`
...
2. `project/PROJECT_EDIT_RULES.md`
3. `project/REFACTOR_PLAN_RU.md`
